# This script will create Azure resources required for setting-up K8s cluster
# Azure VM, NIC, Storage Account, Public IP, Disks
...
adminpwd='put_your_password_here'

# As a best practice, to read the password from end user dynamically uncomment below commands
